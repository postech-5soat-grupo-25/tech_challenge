...
#[openapi(tag = "Users")]
#[get("/")]
async fn get_users(user_use_case: &State<UserUseCase>) -> Result<Json<Vec<Usuario>>, Status> {
...
#[openapi(tag = "Users")]
#[get("/<id>")]
async fn get_user(user_use_case: &State<UserUseCase>, id: usize) -> Result<Json<Usuario>, Status> {
...
async fn create_user(user_use_case: &State<UserUseCase>, user_input: Json<CreateUserInput>) -> Result<Json<Usuario>, Status> {
...
async fn update_user(user_use_case: &State<UserUseCase>, id: usize, update_user_input: Json<UpdateUserInput>) -> Result<Json<Usuario>, Status> {
...
#[openapi(tag = "Users")]
#[delete("/<id>")]
async fn delete_user(user_use_case: &State<UserUseCase>, id: usize) -> Result<Json<String>, Status> {
