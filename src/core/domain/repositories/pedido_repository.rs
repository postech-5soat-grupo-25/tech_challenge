...
pub trait PedidoRepository {
  ...
  async fn cadastrar_acompanhamento(&mut self, pedido_id: usize, acompanhamento_id: usize) -> Result<Pedido, DomainError>;
  
  async fn cadastrar_bebida(&mut self, pedido_id: usize, bebida_id: usize) -> Result<Pedido, DomainError>;
